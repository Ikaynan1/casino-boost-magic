	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				...
				'highlight': '0 0 15px rgba(255, 215, 0, 0.5)'
			},
			backgroundImage: {
				'hero-pattern': 'linear-gradient(to right, #0D1B44, #1A2A6C)',
				'card-gradient': 'linear-gradient(135deg, rgba(255,255,255,0.05) 0%, rgba(255,255,255,0.1) 100%)',
				'button-gradient': 'linear-gradient(90deg, #D4AF37, #FFD700, #D4AF37)',
